...
VALUES 
('M001', 'マフラー', '4500' ,'2025/08/01')

-- 7. 店舗テーブルに下記の3つのデータを同時に追加して下さい。
「店舗コード='EA09'、店舗名='新宿店'、店舗名(アルファベット)='SHINJUKUTEN'、更新日='2012-08-01'」
「店舗コード='WE03'、店舗名='梅田店'、店舗名(アルファベット)='SHINJUKUTEN'、更新日='2013-02-01'」
「店舗コード='WE04'、店舗名='福岡店'、店舗名(アルファベット)='FUKUOKATEN'、更新日='2014-05-01'」
INSERT INTO store_table VALUES ('EA09', '新宿店','SHINJUKUTEN', '2012-08-01');
INSERT INTO store_table VALUES ('WE03', '新宿店','SHINJUKUTEN', '2013-02-01');
INSERT INTO store_table VALUES ('WE04', '福岡店','FUKUOKATEN', '2014-05-01');
