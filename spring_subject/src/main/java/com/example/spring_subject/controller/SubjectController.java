...
import com.example.spring_subject.service.SubjectService;
   ...
   String[] strArr = new String[4];
	try{
               for(int i=0; i <= strArr.length; i++) {
                   strArr[i] = "テスト" + i;
                   System.out.println(strArr[i]); // 5回目のループでArrayIndexOutOfBoundsException発生
               }
	}catch(ArrayIndexOutOfBoundsException e){
	    System.out.println("ArrayIndexOutOfBoundsExceptionの例外が発生しました");
           }
   return "subject/list";
 }
