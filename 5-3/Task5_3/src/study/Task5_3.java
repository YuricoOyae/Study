package study;
	public class Task5_3 {
		...
		public static void main(String[] args) {
			...
			// [商品名のノートパソコンに注文数と単価を代入して合計の結果を出力している。]
			...
			int score = 88;
			String MESSAGE_A= "スコアが90点以上："+score+"点 - とてもよくできました";
			String MESSAGE_B= "スコアが60点以上："+score+"点 - よくできました";
			String MESSAGE_C="スコアが60点未満："+score+"点 - 再テストです";
